...
input bool           EnableDevelopingVAHVAL  = true;           // Enable Developing VAH/VAL
...
input color          SingleColor              = DodgerBlue;        // SingleColor: if ColorScheme is set to Single Color.
input bool           ColorBullBear            = false;          // ColorBullBear: If true, colors are from bars' direction.
input color          MedianColor              = Blue;
input color          ValueAreaSidesColor      = Blue;
input color          ValueAreaHighLowColor    = Blue;
...
input int            MedianWidth              = 4;
input int            MedianRayWidth           = 2;
input int            ValueAreaSidesWidth      = 2;
input int            ValueAreaHighLowWidth    = 2;
input int            ValueAreaRayHighLowWidth = 2;
...
input color          KeyValuesColor           = Blue;       // KeyValuesColor: color for VAH, VAL, POC printout.
...
input int            SinglePrintRayWidth      = 3;
